...
## initialize picamera preview

cap = Picamera2()
cap.preview_configuration.size=(640, 480)
cap.preview_configuration.format = "RGB888"
cap.preview_configuration.transform = Transform(hflip=1, vflip=0)
cap.start()
