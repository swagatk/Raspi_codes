...
def compute_heading_and_distance_to_home(rx, ry, heading, home_target_data):
    ...
    return desired_heading, rotation_deg, linear_distance_m, 0.0
...
def main():
    ...
    while mission_running and (time.time() - home_start < STEP5_RETURN_HOME_TIMEOUT_S):
        ...
        if state == "NAVIGATING":
            ...
            if linear_distance_m is not None and linear_distance_m <= (ALIGN_DIST_TO_HOME / 100.0):
            ...
            moved = execute_forward_with_sensor_guard(
                ...
                STEP5_STEADY_FORWARD_SETTLE_S,
                "Step 5 forward step",
                check_line=(linear_distance_m is not None and linear_distance_m <= (ALIGN_DIST_TO_HOME / 100.0))
            )
